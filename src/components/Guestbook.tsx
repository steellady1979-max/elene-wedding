        ...
        <div className="mt-8">
          {writing ? (
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-parchment/40 px-7 py-2.5 font-geo text-xs tracking-[0.2em] text-parchment transition hover:bg-parchment/15"
            >
