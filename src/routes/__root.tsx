...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ჯაბა და ელენეს ქორწილი — 27 ოქტომბერი, 2026" },
      { name: "author", content: "ჯაბა & ელენე" },
      ...
      { name: "twitter:description", content: "ჯაბა და ელენეს ქორწილი — 27 ოქტომბერი, 2026" },
    ...
    links: [
      { rel: "canonical", href: "https://elene-wedding.vercel.app/" },
      {
        rel: "preload",
        href: "/fonts/tfmecomicse-light.otf",
        as: "font",
        type: "font/otf",
